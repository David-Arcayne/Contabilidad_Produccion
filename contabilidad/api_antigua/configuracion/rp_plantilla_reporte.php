...
class PlantillaReporte extends DB{
    ...
    // $gestion = $this->get_id_gestion($empresa);
       ...
       while ($pl_list = $this->dbc->fetch($plantilla_lista)) {
            ...
            }// AQUI TERMINA EL NO ES CALCULABLE }}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}} _hasta
    ...
    public function registrar_reportes_referencia($idtipo_reporte,$idplantilla,$idtipo_reporte_referencia,$idplantilla_referencia,$empresa){
        // $idempresa = Empresa::getidempresa($empresa); _hasta
        $idempresa = $this->get_id_empresa($empresa);
    ...
    public function reporte_calculo_otro_reporte_consolidado_hasta($idplantilla_reporte,$fecha_fin,$empresa,$gestion) {
        //    ini_set('display_errors', 1); 
        // ini_set('display_startup_errors', 1);
        // error_reporting(E_ALL);
    ...
    // $gestion = $this->get_id_gestion($empresa);
       ...
       while ($pl_list = $this->dbc->fetch($plantilla_lista)) {
            ...
            if($pl_list['tipo_operacion'] == 'calculable'){ // ES CALCULABLE REGISTRO PADREEE
                ...
                $valor_auxi = $this->calculables_estado_resultados_consolidado_hasta($pc['idagrupacion_rubro_plandecuenta'], $idempresa, $gestion,$pl_list['idplandecuenta'],$fecha_fin,$pl_list['idplantilla']);
            ...
            elseif($pl_otro_reporte->num_rows > 0){ // ES UNA PLANTILLA QUE OBTIENE RESULTADO DE OTRO REPORTE
                ...
                $total_otro_reporte =$this->reporte_calculo_otro_reporte_consolidado_hasta(    // TENDRIA QUE USAR OTRO REPORTE QUE ME RETORNE DIRECTAMENTE EL RESULTADO DE LA PLANTILLA 
                $calc_otr_rep['idtipo_reporte_referencia'],   // REPORTE DE REFERENCIA
                $fecha_fin,
                $empresa,
                $gestion
            ...
            while ($aux_nivel_2 = $this->dbc->fetch($pl_padre_calcu)) { //CALCULABLES o TALVES TAMBIEN NO CALCULABLES
                ...
                $valor_total2 = $this->calculables_estado_resultados_consolidado_hasta($nombre_cuenta2['idagrupacion_rubro_plandecuenta'], $idempresa, $gestion,$aux_nivel_2['idplandecuenta'],$fecha_fin,$aux_nivel_2['idplantilla']);
                ...
                if($valor_total2 == null || $valor_total2 <= '0'){
                    ...
                    while ($aux_nivel_3 = $this->dbc->fetch($nivel_3)) {
                        ...
                        if($aux_nivel_3['tipo_operacion'] == 'calculable'){ //SI ES CALCULABLE   
                            ...
                            $valor_total3 = $this->calculables_estado_resultados_consolidado_hasta($nombre_cuenta3['idagrupacion_rubro_plandecuenta'], $idempresa, $gestion,$aux_nivel_3['idplandecuenta'],$fecha_fin,$aux_nivel_3['idplantilla']);
                            ...
                            while ($aux_nivel_4 = $this->dbc->fetch($nivel_4)) {
                                ...
                                if($aux_nivel_4['tipo_operacion'] == 'calculable'){ //SI ES CALCULABLE   
                                    $valor_total4 = $this->calculables_estado_resultados_consolidado_hasta($nombre_cuenta4['idagrupacion_rubro_plandecuenta'], $idempresa, $gestion,$aux_nivel_4['idplandecuenta'],$fecha_fin,$aux_nivel_4['idplantilla']);
                                    ...
                                    while ($aux_nivel_5 = $this->dbc->fetch($nivel_5)) { // ENTRANDO AL NIVEL 555555555
                                        ...
                                        $valor_total5 = $this->calculables_estado_resultados_consolidado_hasta($nombre_cuenta5['idagrupacion_rubro_plandecuenta'], $idempresa, $gestion,$aux_nivel_5['idplandecuenta'],$fecha_fin,$aux_nivel_5['idplantilla']);
    ...
    private function calculables_estado_resultados_consolidado_hasta($id_agru_rubro, $idempresa, $gestion,$idplandecuenta,$fecha_fin,$idplantilla)
    {
        $agru = $this->dbc->query("SELECT * from agrupacion_rubro_plandecuenta where idagrupacion_rubro_plandecuenta = '$id_agru_rubro'");// HIJOS DE LAS PLANTILLAS AGRUPADORAS
        $agru_aux = $agru->fetch_assoc();
