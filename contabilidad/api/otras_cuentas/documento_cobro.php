...
class Documento_cobro extends DB{
    public function registrar_otras_cuentas($idtransaccion,$asiento,$fecha,$lugar,$cliente,$nro_tributario,$contacto,$nro_doc_identidad,$idtipo,$concepto,$condiciones,$observaciones,$precio,$forma_pago,$empresa,$sucursal){
        ...
        if ($asiento != 0) {
            ...
            $registroProveedor = $this->dbc->query("INSERT INTO otras_cuentas(fecha,nro_otras_cuentas,lugar,cliente,nro_tributario,contacto,nro_doc_identidad,idtipo,transacciones_idtransacciones,concepto,condiciones,observaciones,precio,forma_pago,idempresa) 
            VALUES ('$fecha','$nro_otras_cuentas','$lugar','$cliente','$nro_tributario','$contacto','$nro_doc_identidad','$idtipo','$trans','$concepto','$condiciones','$observaciones','$precio','$forma_pago','$idempresa')");
