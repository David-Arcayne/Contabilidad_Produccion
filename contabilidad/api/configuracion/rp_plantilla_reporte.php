...
class PlantillaReporte extends DB{
    ...
    public function listar_agrupacion_plantilla($id_plantilla_padre) {
        ...
        AND (tipo_operacion = 'sumar' || tipo_operacion = 'restar')");
    ...
    //         $pl_padre_calcu = $this->dbc->query("SELECT * FROM pr_plantilla WHERE idplantilla_padre = '$pl_list[idplantilla]'");// VENTAS->NOMBRE --> aqui podria listar todos los hijos de algun padre total_suma como VENTAS
