...
// echo json_encode(array($fechaIni,$fechaFin,$numeroIni,$numeroFin,$empresa,$factura));
   ...
   //TRANSACCIONES --> ID = 50,    DETALLE_TRANSACCION -->ID = 50
    ...
    // $planCuenta=$this->dbc->query("SELECT * FROM plandecuenta WHERE numero >= '$numero_ini' AND numero <= '$numero_fin' AND organizacion_idorganizacion ='$ide' ORDER BY numero ASC"); //antes era dba
    // // $tipo_cuenta = $this->dbc->fetch($planCuenta);  
