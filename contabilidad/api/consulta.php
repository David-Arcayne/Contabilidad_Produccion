...
}elseif($ver[0]=="listar_facturas_cobro_pago"){
    $cont=new Cuentas_transacciones();
    $cont->listar_facturas_cobro_pago($ver[1],$ver[2]);
}elseif($ver[0]=="listar_comprobantes_cobro_pago"){
    $cont=new Cuentas_transacciones();
    $cont->listar_comprobantes_cobro_pago($ver[1],$ver[2]);
}elseif($ver[0]=="listar_comprobantes_asignado_cuentas"){
    $cont=new Cuentas_transacciones();
    $cont->listar_comprobantes_asignado_cuentas($ver[1]);
...
elseif($ver[0]=="facturas_perteneciente_a_cuenta"){
    ...
    $cont=new Cuentas_transacciones();
    $cont->listar_facturas_comercial_cobro($ver[1],$ver[2],$ver[3]);
...
}elseif($ver[0]=="listar_factura_comercial_con_caja_bancos"){
    $cont=new Factura_comercial();
    $cont->listar_factura_comercial_con_caja_bancos($ver[1]);
}elseif($ver[0]=="listar_factura_comercial_sin_cajaBancos"){
    $cont=new Factura_comercial();
...
}elseif($ver[0]=="listar_gestiones_por_idempresa"){
    $cont=new Vinculacion_empresas();
    $cont->listar_gestiones_por_idempresa($ver[1]);
...
}elseif($ver[0]=="listar_cuadro_auxiliar_para_editar"){
    $cont=new Reporte_evolucion_patrimonio();
    $cont->listar_cuadro_auxiliar_para_editar($ver[1]);
}elseif($ver[0]=="select_patrimonio_columnas_mostrar"){
    $cont=new Reporte_evolucion_patrimonio();
    $cont->select_patrimonio_columnas_mostrar($ver[1]);
}elseif($ver[0]=="listar_tipo_reporte_actualizacion_patrimonio"){
    $cont=new Reporte_evolucion_patrimonio();
    $cont->listar_tipo_reporte_actualizacion_patrimonio($ver[1]);
}elseif($ver[0]=="listar_actualizacion_patrimonio_guardados"){
    $cont=new Reporte_evolucion_patrimonio();
    $cont->listar_actualizacion_patrimonio_guardados($ver[1]);
}elseif($ver[0]=="listar_actualizacion_patrimonio_completo_icono"){
    $cont=new Reporte_evolucion_patrimonio();
    $cont->listar_actualizacion_patrimonio_completo_icono($ver[1]);
}elseif($ver[0]=="listar_actualizacion_patrimonio_por_plantilla"){
    $cont=new Reporte_evolucion_patrimonio();
    $cont->listar_actualizacion_patrimonio_por_plantilla($ver[1]);
}elseif($ver[0]=="listar_evolucion_patrimonio"){
    $cont=new Reporte_evolucion_patrimonio();
...
// reporte_flujo_efectivo  rp listadegestion listar_tipo_reportes_activos listar_balance_general_completo_icono
...
// listar_agrupacion_evolucion_patrimonio transaccion listar_facturas_comercial_cobro mayorcuentacontable listar_anular_eliminar_factura
...
// 
//  eliminar_configuracion_reporte  listar_agrupacion_plantilla reportecuentasderesultado reportedetallefpt
...
//  listaasientos listar_todos_documentos_asignado_cuenta  reporteactivodisponible listar_factura_comercial_con_caja_bancos
//
...
//  listar_asignacion_asiento_operacion listar_factura_comercial listatransacciones reporte_balance_general_prueba listar_agrupacion_plantilla facturas_perteneciente_a_cuenta
// 
// 
//  listar_cobros_comercial_sin_cuenta listatransacciones listar_facturas_comercial_cobro
//  reporte_balance_general_por_niveles_consolidados  reporte_estado_origen_aplicacion  listar_solo_usuarios listar_usuarios_por_gestion  
