 ...
 * Descripción: Esta función genera el contenido principal del menú para la gestión de Detalle de Cobros.
 *              Permite ver el detalle de los cobrados y generar reportes en formato PDF.
 * Fecha: 12 de febrero de 2026
 * Autor: Joel Choque
 */
export function DetalleCobrados(datosVista) {
    const {
        permisos,
    ...
    vistaDetalleCobro.append(vistaPrincipal);
    ...
    const regresar = async () => {
        ...
        cambiarVista(vistaDetalleCobro, vistaFacturacionCobro);
        vistaDetalleCobro.innerHTML = "";
    }
...
/**
 * Función: Permite manejar el estado de asignación de una transacción a un registro de cobro.
 ...
 */
/**
 * Permite manejar el estado de asignación de una transacción a un registro de cobro.
 ...
 * @param {Object} datosVista.registro - Registro del cobro que se desea reasignar.
 ...
 */
export function manejarEstadoAsignacionCobroFactura(datosVista) {
    const {
        URL,
        vistaPrincipal,
        contenedorDeAlertas,
    ...
    botonReasignar.addEventListener("click", async (e) => {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            const datosExtra = {
                ver: "registrar_transaccion_recibo",
