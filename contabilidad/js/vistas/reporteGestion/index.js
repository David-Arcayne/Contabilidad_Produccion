...
import { BotonesDescarga } from "./Funcionalidades/Funciones.js";
...
export async function ReporteGestion(codigo, permisos) {
    ...
    const formularioG = crearFormulario(formularioRepGestion, datosFormularioG);
    ...
    ReporteDeGestion(formularioG, contenedorPDF, {URL, empresa_id}, contenidoPDF, contenidoInfo, contenedorPrincipal);
}
