...
export const ReporteBalanceSumasSaldosHasta = async (datosForm, url_rep) => {
    ...
    const subtitulo = `<div><h4>Reporte Balance Sumas y Saldos</h4></div> <span>Fecha: Inicio - ${FormatoDate(datosForm.fechafin)}</span>`;
