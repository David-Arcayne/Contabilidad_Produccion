...
export const ReporteActivoPasivoHasta = async (datosForm, url_rep) => {
    ...
    const subtitulo = `<div><h4>Reporte Activo y Pasivo</h4></div> <span>Fecha: Inicio - ${FormatoDate(datosForm.fechafin)}</span>`;
