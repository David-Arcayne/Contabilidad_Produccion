...
export const ReporteBalanceSumasSaldos = async (datosForm, url_rep) => {
    ...
    const subtitulo = `<div><h4>Reporte Balance Sumas y Saldos</h4></div> <span>Fecha: ${FormatoDate(datosForm.fechaini)} - ${FormatoDate(datosForm.fechafin)}</span>`;
