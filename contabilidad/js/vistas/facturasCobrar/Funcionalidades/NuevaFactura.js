...
import { enviarDatosObj, obtenerDatosAlr, rellenarSelect } from "../../../funciones/Solicitudes.js";
import { formularioNuevaFactura } from "../Formularios.js";
 ...
 */
export function NuevaFactura(codigo, permisos, elementosFxC) {
    ...
    const URL_LT = `${URL}listafacturaapi/${empresa_id}`;
    ...
    const regresar = () => { cambiarVista(vistaNuevaFactura, vistaFxC) }
    const tituloVista = encabezadoVista("Volver", "Facturas", regresar)
        ...
        // "cuenta",
        {
            ...
            usarBasicos: {
                editar: editarRegistroModal({
                    vistaPrincipal,
                    contenedorDeAlertas,
                    camposDeFormulario: formularioNuevaFactura,
                    URL_FORM: URL,
                    URL_LISTAR: URL_LT,
                    estiloTd,
                }, {
    ...
    //     {
    //         id: 2,
    //         "fechatfactura": "2021-09-26",
    //         "nfactura": "F-0002",
    //         "nautorizacion": "1234567890",
    //         "codigocontrol": "ABC123",
    //         "montofactura": 2000.00,
    //         "tasacero": 1,
    //         "export": 1,
    //         "npoliza": "1234567890",
    //         "iceiecdhotros": 1,
    ...
    if (permisos.escritura === "1") {
        nuevoRegistro({
            ...
            datosExtra: [
                { key: "ver", value: "crearfacturasapi" },
...
const NombreTipo = ({elemento, registro}) => {
    elemento.innerHTML = registro.cobrado === "1" ? "Por cobrar" : "Cobrado";
}
...
const columnaCheckbox = (vistaPrincipal) => ({elemento, contenidoTabla, registro, tbody, objectT}) => {
    ...
    input.addEventListener("change", (e) => {
        ...
        btnAsientoM.addEventListener("click", async (e) => {
            ...
            const inputSelect = crearElemento("select", {class: "form-select", id: "factura-transaccion", name: "transaccion__", required: true});
            ...
            // }
            // const sFactura = { datos: datosSFactura, llaves: { id: "id", detalle: [["fechatfactura", "date"], "nfactura", "cliente"] } };
