...
export const ReporteActivoDisponible = async (datosForm, url_rep) => {
    ...
    const subtitulo = `<div><h4>Reporte Activo Disponible</h4></div> <span>${FormatoDate(datosForm.fechaini)} - ${FormatoDate(datosForm.fechafin)}</span>`;
