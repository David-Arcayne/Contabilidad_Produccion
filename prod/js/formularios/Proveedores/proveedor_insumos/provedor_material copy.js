...
async function sitio() {
  ...
  initializeDropdownSearch(codigos.codigo_proveedor, Lista_proveedores,'nombre',false);
  initializeDropdownSearch(codigos.codigo_material, Lista_materiales,'nombre',false);
  ...
  proveedor_select.addEventListener("change", function () {
    ...
    let productos_seleccionados = Lista_mat_pro_reg.find(
      (obj) =>
        Number(obj.proveedor_idproveedor) === Number(proveedor_select.value)
    );
