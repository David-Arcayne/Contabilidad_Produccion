...
async function sitio(){
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 border p-3 rounded mt-4" >
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label for="cantidad_envases" class="form-label">N° envases:</label>
    ...
    select_lista_rubros();
        ...
        initializeDropdownSearch(codigos.codigo_pedido_material, Lista_Material,'nombre',true);
        initializeDropdownSearch(codigos.codigo_pedido_envase, Lista_envases,'nombre',false);
