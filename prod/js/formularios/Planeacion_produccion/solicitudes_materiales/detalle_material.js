...
import { solicitudes_material_produccion } from "./solicitudes_materiales.js";
...
async function sitio(){
 ...
 function volveratrar(){
    solicitudes_material_produccion(code_,permisos_,refrescar_);
 }
    ...
    solicitud.detalles.map((lista)=>{
        ...
        view += `
             <tr style = "style=width: 50px; height: 50px;">
                    <td>${ind++}</td>      
                    <td data-type="${lista.iddetalle_solicitud_material},nombre">${item_material.nombre}</td>          
                    <td data-type="${lista.iddetalle_solicitud_material},cantidad" >${lista.cantidad}</td>
                    <td data-type="${lista.iddetalle_solicitud_material},cantidad" >${item_medida.nombre}</td>
                    <td data-type="${lista.iddetalle_solicitud_material},observaciones">${lista.observaciones}</td>
