...
export async function devoluciones_compra(code_, permisos, refrescar) {
    code = code_;
...
async function listar() {
    try {
        ...
        const resultados = await Promise.all([
            listarFunctions.listar_api_general_verd('listado_devolucion_compra',idEmpresa),
...
const sitio = () => {
    ...
    <div class="container ">
        ...
        <h1 class="text-center mb-4 fw-bold fs-6 ">Devolucion Materiales</h1>
