    ...
    let view=`
        <div class="container">
            ...
            <form id="formulario${codigo}" style="display: none; opacity: 0; height: 0; overflow: hidden; transition: height 0.5s ease, opacity 0.5s ease;">
                    ...
                    <div class="row mt-4">
                        <!-- Selección de tipo de elemento riesgoso -->
                        <div class="col-md-6">
                            <label for="tipo_variable">Tipo de Elemento Riesgoso:</label>
                            ...
                            <small class="form-text text-muted">Elija el tipo de elemento relacionado con el riesgo (por ejemplo: máquina, material, etc.).</small>
                        </div>

                        <!-- Selección del elemento específico -->
                        <div class="col-md-6">
                            <label for="idtipo_variable">Elemento Específico:</label>
                            <select class="form-select" id="idtipo_variable${codigo}" name="idtipo_variable" required>
                                <option value="" disabled selected>Seleccione un elemento específico</option>
                            </select>
                            <small class="form-text text-muted">Seleccione el elemento específico dentro del tipo elegido (por ejemplo: la máquina o el material concreto).</small>
                        </div>
                    </div>
