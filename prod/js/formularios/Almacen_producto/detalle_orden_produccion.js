...
import { ordenes_produccion } from "./ordenes_prod.js";
...
const subcodigo = codigos.codigomodal_editar;


export async function detalle_orden_produccion(code, permisos, refrescar, id,idrubro_) {
...
async function sitio() {
    ...
    let view = `
    <div class="row">
        <a style="float: left;" class="cerrar d-flex align-items-center mt-1" id="volver${subcodigo}">
        ...
        <form id="formulario${subcodigo}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" id="cantidad" name="cantidad" required min="0.1" step="0.1">
                </div>
    ...
    Listar_detalle_orden_produccion(Orden_produccion_detalle.detalles);
        ...
        btncancelar.addEventListener('click', () => {
            ...
            ordenes_produccion(code_,permisos_,refrescar_);
        })
        ...
        const volver = document.getElementById(`volver${subcodigo}`);
...
function Listar_productos_select(){
    let producto = {
        ...
        "codigo": "PH-001",
        "descripcion": "de harina fina importada",
        "cod_barras": "777746535001",
        "fecha_registro": "2023-01-17",
        "imagen": "images/Pan hamburguesa343791.jpg",
        "categorias_id_categorias": 27,
        "medida_id_medida": -1,
        "estados_productos_id_estados_productos": 13,
        "unidad_id_unidad": 15,
        "idempresa": "50",
        "idproducto": 40,
        "idproduct_comercial": 16,
        "estado": 0,
        "cantidad": 100,
        "tiempo_produccion": 0,
        "rubro_idrubro": 6,
        "Unidad_tiempo_idUnidad_tiempo": 3,
        "subproducto": 0
    }
