...
import { control_calidad_compra_finalizados } from "./finalizados.js";
...
export function control_calidad_compra(code_, permisos_, refrescar_) {
    code = code_;
    permisos = permisos_;
...
function sitio(){
    ...
    `;
    app.innerHTML=view;
    control_calidad_compra_pendiente(code,permisos,refrescar);
...
function mostrarSeccion(section) {
    ...
    switch(section) {
        ...
        case 'pendientes':
            ...
            break;
        case 'finalizados':
            control_calidad_compra_finalizados(code,permisos,refrescar);
            break;
        case 'encurso':
            control_calidad_compra_encurso(code,permisos,refrescar);
            break;
