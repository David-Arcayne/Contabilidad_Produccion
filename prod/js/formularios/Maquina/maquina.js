...
export function maquinaConfig_admin(code, permisos, refrescar) {
...
function sitio() {
    ...
    let view = `
        <div class="container ">
            ...
            <form class="" id="formulario${subcodigo}">
                <input type="hidden" name="ver" value="registrar_maquina">
                <input type="hidden" name="empresa" value="${uk[0].empresa.idempresa}">
                <div class="row">

                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            <label for="nombre" class="form-label">Nombre máquina:</label>
                            <input type="text" class="form-control" id="nombre" value="" name="nombre" required>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3" >
                        <div class="form-group">
                            <label for="idtipo_maquina" class="form-label">Seleccione tipo:</label>
                            <select class="form-select" id="tipo${subcodigo}" aria-label="Default select example" name="tipo">
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3" >
                        <div class="form-group">
                            <label for="seccion" class="form-label">Seleccione sección:</label>
                            
                            <select class="form-select" id="seccion${subcodigo}" name="seccion">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="estado${subcodigo}" name="estado">
                ...
                <button type="button" class="btn btn-outline-primary mr-1 mt-4" id="cancelarBtn2${subcodigo}" aria-label="Cancelar">Cancelar</button>
            ...
            <div class="scrollable-table mt-4">
                <table class="table table-hover" id = "editableTable${subcodigo}">
                    ...
                    <tbody id="listar_maquina"></tbody>
                </table>
            </div>
            <div id="configuracion${subcodigo}" class="container" >
    ...
    .then(() => {
        ...
        const cancelarBtn2 = document.getElementById(`cancelarBtn2${subcodigo}`);
        ...
        toggleButton.addEventListener("click", (e) => mostrarFormulario(e,toggleButton,forme,"Maquina"));
