...
async function sitio() {
    ...
    let item_detalle = Lista_Detalle_Control_calidad.find(obj => obj.iddetalle_control_calidad === Number(id_Detalle));
 
    let lista_dcc = Listas_Control_calidad.find(obj => obj.id == Number(id));
  
    let itemMaterial = seleccionar_entidad_tipo(item_detalle.entidad_tipo,item_detalle.entidad_id);

    let item_medida = Lista_medidas.find(obj => Number(obj.id) === Number(itemMaterial.medida));
    ...
    let view = `
         ...
         <div class="row">
            <div class="select-container">
                ...
                <label for="seccion" class="form-label fw-bold fs-6 row">Cantidad: ${item_detalle.cantidad} ${item_medida.nombre}</label>

            </div>
            <div class="select-container" id="select1">
                <label for="seccion1" class="form-label fw-bold fs-6">Seleccionar  características de evaluación</label>
            ...
            <div class="select-container" id="select2">
                <label for="seccion2" class="form-label fw-bold fs-6">Seleccionar características de la muestra</label>
                <div class="select-box" id="selectBox2">Opciones características muestra <span>▼</span></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="peso_bruto" style="background-color: rgba(108, 117, 125, 0.5);" id="peso_bruto${codigo}" readonly>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" name="calificacion" style="background-color: rgba(108, 117, 125, 0.5);"  id="calificacion${codigo}" readonly required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="radio" name="destino" id="radioAlmacen" value="Almacén" required title="Debes seleccionar una opción">
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="destino" id="radioDevolución" value="Devolución" required>
