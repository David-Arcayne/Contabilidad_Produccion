...
import { formularioTipoIventario, opcionesTipo } from "./Formularios.js";
 ...
 */
export function TipoInventario(codigo, permisos) {
    const URL = "./api/tipo-inventario";
        ...
        "tipo",
        {
            ...
            usarBasicos: {
                editar: editarRegistro({
                    ...
                    vistaEditar,
                    contenedorDeAlertas,
                    camposDeFormulario: formularioTipoIventario,
    ...
    if (permisos.editar === "0" && permisos.eliminar === "0") {
        ...
        delete contenidoTabla[1].usarBasicos.editar;
    } else if (permisos.eliminar === "0"){
        delete contenidoTabla[1].usarBasicos.eliminar;
    }
    const [tabla, tBody] = crearTabla(encabezadoTabla);
    const elementosModal = VistaPDF("Inventario", [`${URL}/reporte-pdf`, "GET", undefined, undefined, undefined, undefined, "tipo_inventario"]);
