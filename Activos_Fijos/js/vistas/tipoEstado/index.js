...
import { formularioTipoEstado } from "./Formularios.js";
 ...
 */
export function TipoEstado(codigo, permisos) {
    const URL = "./api/tipo-estado";
        ...
        "descripcion",
        {
            ...
            usarBasicos: {
                editar: editarRegistro({
                    ...
                    vistaEditar,
                    contenedorDeAlertas,
                    camposDeFormulario: formularioTipoEstado,
                    URL,
                    estiloTd,
                }),
    ...
    const elementosModal = VistaPDF("Tipos de estado", [`${URL}/reporte-pdf`, "GET", undefined, undefined, undefined, undefined, "tipos_de_estado"]);
