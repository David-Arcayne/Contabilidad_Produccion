 ...
 */
export function SolicitarActivo(codigo, permisos) {
    const URL = "./api/solicitud-activo";
...
const comprobante = ({elemento, registro}) => {
    // solicitudPDF(`./api/solicitud-activo/comprobante/${registro.id}/solicitud`, "GET");
    ...
    const elementosModal = VistaPDF("Solicitud", [`./api/solicitud-activo/comprobante/${registro.id}/solicitud`, "GET", undefined, undefined, undefined, undefined, "comprobante-de-solicitud"]);
    const btnModal = BotonPDF(elementosModal, ContenidoPDF(`./api/solicitud-activo/comprobante-js/${registro.id}/solicitud`));
    btnModal(elemento);
}