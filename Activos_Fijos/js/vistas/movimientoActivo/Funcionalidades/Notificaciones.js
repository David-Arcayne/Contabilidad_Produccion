 ...
 * @returns 
 */
export const Notificacion = (vistaPrincipal) => {
    ...
    (async () => {    
            ...
            if (listaDeRegistros && listaDeRegistros.rows) {
                ...
                const btnAlerta = crearElemento("button", {class: "btn btn-sm btn-primary rounded-5"}, [i, " Ver sugerencias"]); 
                    ...
                    const modalDarDeBaja = () => {
                        ...
                        listaDeRegistros.data.forEach((registro) => {
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col">
                                            <div class="p-2 pe-0">
                                                ...
                                                <h6 class="card-text mb-1">${registro.observacion}</h6>
                            ...
                            btnBorrar.addEventListener("click", async () => {
                                const respuesta = await enviarDatos(`./api/inventarios-activofijo/cambiar-accion/${registro.id}`, "PUT");
                                if (respuesta) {
